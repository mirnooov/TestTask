...
Shader "Malbers/Fur"
{
	Properties
	{
		...
		[ASEBegin]_Thickness("Thickness", Range( 0 , 1)) = 0
		_AlphaClipShadow("Alpha Clip Shadow", Range( 0 , 1)) = 0
		...
		[ASEEnd]_AnisotropyOffset("Anisotropy Offset", Range( -1 , 1)) = -1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Albedo1 = packedInput.ase_texcoord5.xy;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo1 ) * _Tint );
				float4 color92 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 lerpResult91 = lerp( ( temp_output_3_0 * _AO ) , color92 , packedInput.ase_color.r);
				float4 saferPower98 = max( ( lerpResult91 + ( 1.0 - _AOPower ) ) , 0.0001 );
				float4 temp_cast_0 = (_AOExp).xxxx;
				float4 clampResult96 = clamp( pow( saferPower98 , temp_cast_0 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				float2 uv2_FurNormal72 = packedInput.interp03.xy;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv2_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				float2 uv_BodyNormal5 = packedInput.ase_texcoord5.xy;
				...
				float3 NormalMap63 = unpack5;
				float3 lerpResult74 = lerp( tex2DNode72 , NormalMap63 , float3( 0.5,0.5,0.5 ));
				
				float2 uv_Emission58 = packedInput.ase_texcoord5.xy;
				...
				float3 tanNormal23 = NormalMap63;
				...
				float3 LightDirection33 = SafeNormalize(-_DirectionalLightDatas[0].forward);
				...
				float2 uv2_FurMap212 = packedInput.interp03.xy;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv2_FurMap212 ).r ) * nDotL38 );
				
				float2 uv2_FurMap14 = packedInput.interp03.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv2_FurMap14 );
				
				surfaceDescription.Albedo = ( temp_output_3_0 * clampResult96 ).rgb;
				surfaceDescription.Normal = lerpResult74;
				...
				surfaceDescription.Emission = ( _EmissionPower * ( tex2D( _Emission, uv_Emission58 ) * _EmissionColor ) ).rgb;
				surfaceDescription.Smoothness = ( _SpecularPower + temp_output_50_0 );
				...
				surfaceDescription.AlphaClipThresholdShadow = _AlphaClipShadow;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Albedo1 = packedInput.ase_texcoord.xy;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo1 ) * _Tint );
				float4 color92 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 lerpResult91 = lerp( ( temp_output_3_0 * _AO ) , color92 , packedInput.ase_color.r);
				float4 saferPower98 = max( ( lerpResult91 + ( 1.0 - _AOPower ) ) , 0.0001 );
				...
				float2 uv2_FurNormal72 = packedInput.ase_texcoord.zw;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv2_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				float2 uv_BodyNormal5 = packedInput.ase_texcoord.xy;
				float3 unpack5 = UnpackNormalScale( tex2D( _BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				unpack5.z = lerp( 1, unpack5.z, saturate(_NormalPowerBody) );
				float3 NormalMap63 = unpack5;
				float3 lerpResult74 = lerp( tex2DNode72 , NormalMap63 , float3( 0.5,0.5,0.5 ));
				
				float2 uv_Emission58 = packedInput.ase_texcoord.xy;
				...
				float dotResult39 = dot( PixelNormalWorld24 , HalfVector37 );
				float nDotH40 = dotResult39;
				float2 uv2_FurMap212 = packedInput.ase_texcoord.zw;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv2_FurMap212 ).r ) * nDotL38 );
				
				float2 uv2_FurMap14 = packedInput.ase_texcoord.zw;
				float4 tex2DNode4 = tex2D( _FurMap1, uv2_FurMap14 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = inputMesh.ase_texcoord1.xy;
					...
					)
			{
				...
				float2 uv2_FurMap14 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv2_FurMap14 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv2_FurNormal72 = packedInput.ase_texcoord3.xy;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv2_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				float2 uv_BodyNormal5 = packedInput.ase_texcoord3.zw;
				float3 unpack5 = UnpackNormalScale( tex2D( _BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				unpack5.z = lerp( 1, unpack5.z, saturate(_NormalPowerBody) );
				float3 NormalMap63 = unpack5;
				float3 lerpResult74 = lerp( tex2DNode72 , NormalMap63 , float3( 0.5,0.5,0.5 ));
				...
				float dotResult39 = dot( PixelNormalWorld24 , HalfVector37 );
				float nDotH40 = dotResult39;
				float2 uv2_FurMap212 = packedInput.ase_texcoord3.xy;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv2_FurMap212 ).r ) * nDotL38 );
				
				float2 uv2_FurMap14 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv2_FurMap14 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Albedo1 = packedInput.ase_texcoord7.xy;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo1 ) * _Tint );
				float4 color92 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 lerpResult91 = lerp( ( temp_output_3_0 * _AO ) , color92 , packedInput.ase_color.r);
				float4 saferPower98 = max( ( lerpResult91 + ( 1.0 - _AOPower ) ) , 0.0001 );
				...
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				float2 uv_BodyNormal5 = packedInput.ase_texcoord7.xy;
				float3 unpack5 = UnpackNormalScale( tex2D( _BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				unpack5.z = lerp( 1, unpack5.z, saturate(_NormalPowerBody) );
				float3 NormalMap63 = unpack5;
				float3 lerpResult74 = lerp( tex2DNode72 , NormalMap63 , float3( 0.5,0.5,0.5 ));
				
				float2 uv_Emission58 = packedInput.ase_texcoord7.xy;
...
/*ASEBEGIN
Version=18800
309;162;1266;746;236.1335;978.5072;1.379773;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1037.949,635.9708;Float;False;Property;_NormalPowerBody;Normal Power Body;13;0;Create;True;0;0;0;False;0;False;0;1.5;-3;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-723,577.5;Inherit;True;Property;_BodyNormal;Body Normal;11;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;13579146ea933b144b166890fb81a011;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-1852.1,678.4998;Float;False;Property;_AnisotropyOffset;Anisotropy Offset;20;0;Create;True;0;0;0;False;0;False;-1;-0.3;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-113.8526,-420.7391;Inherit;True;Property;_Albedo;Albedo;3;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;6736744417acb8844bf0f7ad314c1f25;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2;-69.82749,-210.2128;Inherit;False;Property;_Tint;Tint;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.9245283,0.8531069,0.7893378,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;88;-117.2237,-910.7299;Inherit;False;Property;_AO;AO;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;226.1725,-383.2127;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RadiansOpNode;43;-1295.286,1046.266;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;515.8184,-492.3306;Inherit;False;Property;_AOPower;AO Power;6;0;Create;True;0;0;0;False;0;False;0;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;45;-1121.484,1047.165;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;77;458.5325,-682.5943;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;92;231.0318,-1164.434;Inherit;False;Constant;_White;White;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1851.465,758.1081;Float;False;Property;_AnisotropyFalloff;Anisotropy Falloff;19;0;Create;True;0;0;0;False;1;Header(Anisotropy);False;64;66;1;256;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;97;807.1168,-568.8165;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;46;-961.5074,1046.131;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;665.329,-415.349;Inherit;False;Property;_AOExp;AO Exp;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;12;-767.949,776.9708;Inherit;True;Property;_FurMap2;Fur Map1 (Spec AO Trans);18;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;a955501da94190a43bfa2af7ebbf2bea;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;98;1161.885,-718.534;Inherit;False;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;58;-291.669,75.74873;Inherit;True;Property;_Emission;Emission;8;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;654af7c78d16add428013c20bac17641;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;76;-1055.746,166.3885;Float;False;Property;_NormalPowerFur;Normal Power Fur;14;0;Create;True;0;0;0;False;0;False;0;0.75;-3;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;56;-270.6222,272.7609;Inherit;False;Property;_EmissionColor;Emission Color;9;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;48.35571,113.275;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;96;1355.538,-733.1806;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;72;-771.0619,108.194;Inherit;True;Property;_FurNormal;Fur Normal;12;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;b2b11ef38a0e7764a879b324c668a443;True;1;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-52.99253,6.776186;Float;False;Property;_EmissionPower;Emission Power;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-187.3074,826.2288;Float;False;Property;_SpecularPower;Specular Power;16;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;638.727,162.5923;Inherit;True;Property;_FurMap1;Fur Map1 (A Height ID Root);17;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;4465e4dc19128b841bf2a8338c3e6792;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;55;1017.843,-48.5145;Inherit;False;Property;_Metallic;Metallic;15;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;1129.65,339.7583;Inherit;False;Property;_AlphaClipShadow;Alpha Clip Shadow;1;0;Create;True;0;0;0;False;0;False;0;0.115;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;895.1376,393.1913;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;52;170.4147,939.1705;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;134;1122.228,434.7505;Inherit;False;Property;_Thickness;Thickness;0;0;Create;True;0;0;0;False;0;False;0;0.27;0;1;0;1;FLOAT;0
...
WireConnection;120;4;55;0
WireConnection;120;6;62;0
WireConnection;120;7;71;0
WireConnection;120;9;4;1
WireConnection;120;10;132;0
WireConnection;120;30;133;0
WireConnection;120;16;134;0
ASEEND*/
//CHKSM=B671A6E598B95510F1EFC982177A7A9D976E49C4