...
Shader "Malbers/Anisotropic/Ward"
{
	Properties
	{
		...
		[ASEBegin]_TillingOffset("Tilling & Offset", Vector) = (1,1,0,0)
		...
		[ASEEnd]_AnisotropyY("Anisotropy Y", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord82 = packedInput.ase_texcoord5.xy * appendResult85 + float2( 0,0 );
				float4 temp_output_60_0 = ( tex2D( _Albedo, texCoord82 ) * _AlbedoTint );
				...
				float3 LightDirection12 = SafeNormalize(-_DirectionalLightDatas[0].forward);
				...
				float3 normalizeResult76 = normalize( cross( NormalDirection56 , tangentWS.xyz ) );
				...
				surfaceDescription.Albedo = temp_output_60_0.rgb;
				surfaceDescription.Normal = tex2DNode25;
				...
				surfaceDescription.Smoothness = ( ( tex2D( _Specular, texCoord82 ) * _SpecularTint ) * ( exp( ( ( ( ( HX68 * HX68 ) + ( HY41 * HY41 ) ) / ( NdotH30 + 1.0 ) ) * -2.0 ) ) * max( NdotL27 , 0.0 ) ) ).r;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_60_0.a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult85 = (float2(_TillingOffset.z , _TillingOffset.w));
				float2 texCoord82 = packedInput.ase_texcoord.xy * appendResult85 + float2( 0,0 );
				float4 temp_output_60_0 = ( tex2D( _Albedo, texCoord82 ) * _AlbedoTint );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult85 = (float2(_TillingOffset.z , _TillingOffset.w));
				float2 texCoord82 = packedInput.ase_texcoord1.xy * appendResult85 + float2( 0,0 );
				float4 temp_output_60_0 = ( tex2D( _Albedo, texCoord82 ) * _AlbedoTint );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult85 = (float2(_TillingOffset.z , _TillingOffset.w));
				float2 texCoord82 = packedInput.ase_texcoord3.xy * appendResult85 + float2( 0,0 );
				float3 unpack25 = UnpackNormalScale( tex2D( _NormalMap, texCoord82 ), _NormalAmount );
				unpack25.z = lerp( 1, unpack25.z, saturate(_NormalAmount) );
				float3 tex2DNode25 = unpack25;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult85 = (float2(_TillingOffset.z , _TillingOffset.w));
				float2 texCoord82 = packedInput.ase_texcoord7.xy * appendResult85 + float2( 0,0 );
				float4 temp_output_60_0 = ( tex2D( _Albedo, texCoord82 ) * _AlbedoTint );
...
/*ASEBEGIN
Version=18800
309;162;1266;746;102.5652;725.7095;1.522842;True;False
Node;AmplifyShaderEditor.Vector4Node;83;-5104.344,-1005.934;Float;True;Property;_TillingOffset;Tilling & Offset;0;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,4.51,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-4477.512,-483.7573;Float;False;Property;_NormalAmount;Normal Amount;6;0;Create;True;0;0;0;False;0;False;1;1.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;25;-4161.5,-542.8994;Inherit;True;Property;_NormalMap;Normal Map;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1613.096,9.198168;Float;False;Property;_AnisotropyX;Anisotropy X;7;0;Create;True;0;0;0;False;0;False;1;0.5508147;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-1649.396,265.4982;Float;False;Property;_AnisotropyY;Anisotropy Y;8;0;Create;True;0;0;0;False;0;False;1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;65;269.2042,-95.6257;Float;False;Property;_SpecularTint;Specular Tint;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.7279412,0.5353365,0.1712803,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;61;221.8039,-293.2251;Inherit;True;Property;_Specular;Specular;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;59;256.7027,-603.4249;Float;False;Property;_AlbedoTint;Albedo Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.3235294,0.2737639,0.2355294,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;95;7;63;0
WireConnection;95;9;66;3
ASEEND*/
//CHKSM=B83AEB298DA1C2D3361B3A26FE54AFA6905A3A17