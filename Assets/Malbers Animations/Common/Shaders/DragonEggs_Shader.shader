...
Shader "Malbers/DragonEggs"
{
	Properties
	{
		...
		[ASEBegin][NoScaleOffset]_DiffuseMap("Diffuse Map", 2D) = "white" {}
		...
		[ASEEnd]_EmmisionPower("Emmision Power", Range( 0 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , texCoord19.y);
				float2 uv_DiffuseMap1 = packedInput.ase_texcoord5.xy;
				float4 blendOpSrc8 = lerpResult26;
				float4 blendOpDest8 = tex2D( _DiffuseMap, uv_DiffuseMap1 );
				
				float2 uv_NormalMap3 = packedInput.ase_texcoord5.xy;
				float3 unpack3 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normal) );
				
				float2 uv_EmmisionMap2 = packedInput.ase_texcoord5.xy;
				float4 blendOpSrc10 = _Emission;
				float4 blendOpDest10 = tex2D( _EmmisionMap, uv_EmmisionMap2 );
				
				float2 uv_RoughnessMap6 = packedInput.ase_texcoord5.xy;
				
				surfaceDescription.Albedo = ( saturate( 2.0f*blendOpDest8*blendOpSrc8 + blendOpDest8*blendOpDest8*(1.0f - 2.0f*blendOpSrc8) )).rgb;
				...
				surfaceDescription.Emission = ( ( saturate( (( blendOpDest10 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest10 ) * ( 1.0 - blendOpSrc10 ) ) : ( 2.0 * blendOpDest10 * blendOpSrc10 ) ) )) * _EmmisionPower ).rgb;
				surfaceDescription.Smoothness = ( ( 1.0 - tex2D( _RoughnessMap, uv_RoughnessMap6 ) ) * _Rough ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord19 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , texCoord19.y);
				float2 uv_DiffuseMap1 = packedInput.ase_texcoord.xy;
				float4 blendOpSrc8 = lerpResult26;
				float4 blendOpDest8 = tex2D( _DiffuseMap, uv_DiffuseMap1 );
				
				float2 uv_NormalMap3 = packedInput.ase_texcoord.xy;
				float3 unpack3 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normal) );
				
				float2 uv_EmmisionMap2 = packedInput.ase_texcoord.xy;
				float4 blendOpSrc10 = _Emission;
				float4 blendOpDest10 = tex2D( _EmmisionMap, uv_EmmisionMap2 );
				
				float2 uv_RoughnessMap6 = packedInput.ase_texcoord.xy;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NormalMap3 = packedInput.ase_texcoord3.xy;
				float3 unpack3 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normal) );
				
				float2 uv_RoughnessMap6 = packedInput.ase_texcoord3.xy;
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , texCoord19.y);
				float2 uv_DiffuseMap1 = packedInput.ase_texcoord7.xy;
				float4 blendOpSrc8 = lerpResult26;
				float4 blendOpDest8 = tex2D( _DiffuseMap, uv_DiffuseMap1 );
				
				float2 uv_NormalMap3 = packedInput.ase_texcoord7.xy;
				float3 unpack3 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normal) );
				
				float2 uv_EmmisionMap2 = packedInput.ase_texcoord7.xy;
				float4 blendOpSrc10 = _Emission;
				float4 blendOpDest10 = tex2D( _EmmisionMap, uv_EmmisionMap2 );
				
				float2 uv_RoughnessMap6 = packedInput.ase_texcoord7.xy;
...
WireConnection;48;4;11;0
WireConnection;48;6;47;0
WireConnection;48;7;17;0
ASEEND*/
//CHKSM=2EBA22AB1147D403A278543E6324CC5C61B47797