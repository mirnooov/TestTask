...
Shader "Malbers/SimpleOutline"
{
	Properties
	{
		...
		[ASEEnd]_Smooth("Smooth", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Normal2 = packedInput.ase_texcoord5.xy;
				float3 unpack2 = UnpackNormalScale( tex2D( _Normal, uv_Normal2 ), _NormalPower );
				unpack2.z = lerp( 1, unpack2.z, saturate(_NormalPower) );
				
				surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo1 ) * _Tint ).rgb;
				surfaceDescription.Normal = unpack2;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Normal2 = packedInput.ase_texcoord.xy;
				float3 unpack2 = UnpackNormalScale( tex2D( _Normal, uv_Normal2 ), _NormalPower );
				unpack2.z = lerp( 1, unpack2.z, saturate(_NormalPower) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Normal2 = packedInput.ase_texcoord3.xy;
				float3 unpack2 = UnpackNormalScale( tex2D( _Normal, uv_Normal2 ), _NormalPower );
				unpack2.z = lerp( 1, unpack2.z, saturate(_NormalPower) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Normal2 = packedInput.ase_texcoord7.xy;
				float3 unpack2 = UnpackNormalScale( tex2D( _Normal, uv_Normal2 ), _NormalPower );
				unpack2.z = lerp( 1, unpack2.z, saturate(_NormalPower) );
...
/*ASEBEGIN
Version=18800
309;162;1266;746;976;165;1;True;False
Node;AmplifyShaderEditor.ColorNode;4;-541.6617,8.790344;Inherit;False;Property;_Tint;Tint;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-580,-187;Inherit;True;Property;_Albedo;Albedo;1;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-925,208;Inherit;False;Property;_NormalPower;Normal Power;3;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=7E3569973C4811204042F90BD5B7104B9C17CF13