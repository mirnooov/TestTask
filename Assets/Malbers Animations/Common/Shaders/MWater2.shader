...
Shader "Malbers/MWater2"
{
	Properties
	{
		...
		[ASEBegin]_WaterColor("WaterColor", Color) = (0.2074582,0.2643323,0.3962264,1)
		...
		[ASEEnd]_Wave2Tile("Wave2 Tile", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 fetchOpaqueVal27 = ASEHDSampleSceneColor(( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( temp_output_13_0 * _Distortion ) ).xy, 0, GetInverseCurrentExposureMultiplier());
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth7 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				surfaceDescription.Albedo = ( fetchOpaqueVal27 * lerpResult26 ).rgb;
				surfaceDescription.Normal = temp_output_13_0;
				...
				surfaceDescription.Emission = ( _EdgeColor * Edge21 ).rgb;
...
/*ASEBEGIN
Version=18800
309;162;1266;746;244.2018;469.3976;1.287469;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-83.84126,694.1061;Float;False;Property;_EdgeDistance;Edge Distance;7;0;Create;True;0;0;0;False;0;False;0.24;0.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-73.22799,790.1958;Float;False;Property;_EdgeStrength;Edge Strength;8;0;Create;True;0;0;0;False;0;False;0.24;0.74;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;25;-32.01868,50.61902;Float;False;Property;_EdgeColor;Edge Color;1;0;Create;True;0;0;0;False;0;False;0.7768779,0.7869238,0.8113208,1;0.256586,0.4581287,0.5849056,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;23;-37.30762,-125.5352;Float;False;Property;_WaterColor;WaterColor;0;0;Create;True;0;0;0;False;0;False;0.2074582,0.2643323,0.3962264,1;0.134167,0.3453069,0.6320754,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenColorNode;27;42.60632,-399.6122;Float;False;Global;_WaterGrab;WaterGrab;-1;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;29;372.0723,174.0415;Float;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
WireConnection;38;4;29;0
WireConnection;38;6;31;0
WireConnection;38;7;28;0
ASEEND*/
//CHKSM=54241A23C6897D82DEF5BC06FA365AE57A516872