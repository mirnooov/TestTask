...
Shader "Malbers/Anisotropic/Circular"
{
	Properties
	{
		...
		[ASEBegin][NoScaleOffset]_AlbedoRGBOpacityA("Albedo (RGB) Opacity (A)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
				
				float2 uv_Normal45 = packedInput.ase_texcoord5.xy;
				...
				float2 uv_Specular4 = packedInput.ase_texcoord5.xy;
				...
				float3 LightDirection16 = SafeNormalize(-_DirectionalLightDatas[0].forward);
				...
				surfaceDescription.Albedo = ( _AlbedoTint * tex2DNode1 ).rgb;
				surfaceDescription.Normal = NormalMap62;
				...
				surfaceDescription.Smoothness = max( ( ( ( _SpecularTint * tex2D( _Specular, uv_Specular4 ) ) * pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH24 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) ) * nDotL22 ) , float4( 0,0,0,0 ) ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
				
				float2 uv_Normal45 = packedInput.ase_texcoord.xy;
				float3 unpack45 = UnpackNormalScale( tex2D( _Normal, uv_Normal45, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
				unpack45.z = lerp( 1, unpack45.z, saturate(_NormalAmount) );
				float3 NormalMap62 = unpack45;
				
				float2 uv_Specular4 = packedInput.ase_texcoord.xy;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Normal45 = packedInput.ase_texcoord3.xy;
				float3 unpack45 = UnpackNormalScale( tex2D( _Normal, uv_Normal45, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
				unpack45.z = lerp( 1, unpack45.z, saturate(_NormalAmount) );
				float3 NormalMap62 = unpack45;
				
				float2 uv_Specular4 = packedInput.ase_texcoord3.xy;
				...
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
				
				float2 uv_Normal45 = packedInput.ase_texcoord7.xy;
				float3 unpack45 = UnpackNormalScale( tex2D( _Normal, uv_Normal45, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
				unpack45.z = lerp( 1, unpack45.z, saturate(_NormalAmount) );
				float3 NormalMap62 = unpack45;
				
				float2 uv_Specular4 = packedInput.ase_texcoord7.xy;
...
/*ASEBEGIN
Version=18800
309;162;1266;746;1775.52;751.1234;1.818721;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-4441.228,56.32429;Float;False;Property;_NormalAmount;Normal Amount;5;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;45;-4064.827,-44.64075;Inherit;True;Property;_Normal;Normal;4;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2303.304,176.503;Float;False;Property;_AnisotropyOffset;Anisotropy Offset;7;0;Create;True;0;0;0;False;0;False;-1;-0.33;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1599.799,508.6237;Float;False;Property;_AnisotropyFalloff;Anisotropy Falloff;6;0;Create;True;0;0;0;False;0;False;64;82;1;256;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;43;-1315.204,-195.798;Float;False;Property;_SpecularTint;Specular Tint;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;40;-1266.202,-631.3965;Float;False;Property;_AlbedoTint;Albedo Tint;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.0849056,0.0849056,0.0849056,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;71;-580.2626,-531.0775;Inherit;True;62;NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
...
WireConnection;72;7;54;0
WireConnection;72;9;1;4
ASEEND*/
//CHKSM=4225705F02916CA6AFC8271DFCC9EFF9C2929DF5