	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float fresnelNdotV34 = dot( ase_worldNormal, V );
				...
				float2 uv_Pattern = packedInput.ase_texcoord2.xy * _Pattern_ST.xy + _Pattern_ST.zw;
				...
				float2 uv_Gradient95 = packedInput.ase_texcoord2.xy;
				...
				surfaceDescription.Emission = ( saturate( 2.0f*blendOpDest80*blendOpSrc80 + blendOpDest80*blendOpDest80*(1.0f - 2.0f*blendOpSrc80) )).rgb;
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_49_0 = ( 1.0 - ( fresnelNode34 + 0.0 ) );
				float4 temp_cast_0 = (( temp_output_49_0 * temp_output_49_0 * temp_output_49_0 )).xxxx;
				float2 uv_Pattern = packedInput.ase_texcoord4.xy * _Pattern_ST.xy + _Pattern_ST.zw;
				float2 panner4 = ( 1.0 * _Time.y * _Speed1 + ( uv_Pattern * _Tillling1 ));
				float4 Noise128 = tex2D( _Pattern, panner4 );
				float2 panner18 = ( 1.0 * _Time.y * _Speed2 + ( uv_Pattern * _Tilling2 ));
				float4 Noise227 = tex2D( _Pattern, panner18 );
				float2 uv_Gradient95 = packedInput.ase_texcoord4.xy;
				float4 temp_output_68_0 = ( CalculateContrast(_Volume,temp_cast_0) * ( ( Noise128 * Noise227 ) * _Opacity * tex2D( _Gradient, uv_Gradient95 ) ) );
...
/*ASEBEGIN
Version=18800
309;162;1266;746;870.1132;235.725;1.62699;True;False
...
Node;AmplifyShaderEditor.Vector2Node;3;-2245.02,-409.1553;Float;False;Property;_Tillling1;Tillling 1;3;0;Create;True;0;0;0;False;0;False;1,1;1,0.09;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;19;-2069.387,208.8528;Float;False;Property;_Tilling2;Tilling 2;4;0;Create;True;0;0;0;False;0;False;2,2;2,0.24;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;5;-1813.152,-343.9073;Float;False;Property;_Speed1;Speed 1;5;0;Create;True;0;0;0;False;0;False;0.2,0.2;-0.05,-0.06;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;20;-1810.195,390.0498;Float;False;Property;_Speed2;Speed 2;6;0;Create;True;0;0;0;False;0;False;0.2,0;0.03,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;76;-1501.124,-120.443;Float;True;Property;_Pattern;Pattern;0;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;b44ea59463ef6d941872d19b3faf784d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-605.2021,1047.539;Float;False;Property;_Opacity;Opacity;7;0;Create;True;0;0;0;False;0;False;0.75;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;94;-511.0547,660.0659;Float;False;Property;_Volume;Volume;8;0;Create;True;0;0;0;False;0;False;2;3.64;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;10;66.81532,335.962;Float;False;Property;_WindColor1;Wind Color 1;2;0;Create;True;0;0;0;False;0;False;0.7924528,0.6378148,0.3999644,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;116;1;80;0
WireConnection;116;2;68;0
ASEEND*/
//CHKSM=6A4B97EF553F4F4C11307BD4B9C94D5FD42F9201