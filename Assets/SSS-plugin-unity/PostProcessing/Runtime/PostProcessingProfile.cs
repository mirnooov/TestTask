...
namespace UnityEngine.PostProcessing
{
    public class PostProcessingProfile : ScriptableObject
    {
        ...
        public SubsurfaceScatteringSupportModel subsurfaceScatteringSupport = new SubsurfaceScatteringSupportModel();
        public SubsurfaceScatteringModel subsurfaceScattering = new SubsurfaceScatteringModel();
        //----------------------------------------------------------
