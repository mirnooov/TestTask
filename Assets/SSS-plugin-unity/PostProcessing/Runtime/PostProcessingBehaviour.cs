...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        //----------------------------------------------------------
        //Custom Subsurface Scattering Implementation 
        public SubsurfaceScatteringSupportComponent m_SubsurfaceScatteringSupport;
        public SubsurfaceScatteringComponent        m_SubsurfaceScattering;
        //----------------------------------------------------------
        ...
        void OnEnable()
        {
            ...
            //----------------------------------------------------------
            //Custom Subsurface Scattering Implementation 
            m_SubsurfaceScatteringSupport = AddComponent(new SubsurfaceScatteringSupportComponent());
            m_SubsurfaceScattering        = AddComponent(new SubsurfaceScatteringComponent());
            //----------------------------------------------------------
        ...
        void OnPreCull()
        {
            ...
            //----------------------------------------------------------
            //Custom Subsurface Scattering Implementation 
            m_SubsurfaceScatteringSupport.Init(context, profile.subsurfaceScatteringSupport);
            m_SubsurfaceScattering.Init(context, profile.subsurfaceScattering);
            //----------------------------------------------------------
        ...
        void OnPreRender()
        {
            ...
            //----------------------------------------------------------
            //Custom Subsurface Scattering Implementation 
            TryExecuteCommandBuffer(m_SubsurfaceScatteringSupport);
            TryExecuteCommandBuffer(m_SubsurfaceScattering);
            //----------------------------------------------------------
