...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    half4 c = FABRIC_BRDF (s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, -s.eyeVec, gi.light, gi.indirect, sd);
...
half4 fragForwardAddInternal (VertexOutputForwardAdd i)
{
    ...
    half4 c = FABRIC_BRDF (s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, -s.eyeVec, light, noIndirect, sd);

    //UNITY_APPLY_FOG_COLOR(i.fogColor, c.rgb, half4(0,0,0,0));
    return OutputForward(c, s.alpha);
}
