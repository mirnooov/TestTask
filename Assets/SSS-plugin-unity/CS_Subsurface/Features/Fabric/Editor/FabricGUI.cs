...
{
    internal class FabricGUI : ShaderGUI
    {
        ...
        public void FabricPropertiesGUI(Material material)
        {
            ...
            m_MaterialEditor.ShaderProperty(doubleSided, Styles.doubleSidedModeText);
            if(material.GetFloat(kDoubleSided) == 1){
                EditorGUI.indentLevel++;
                m_MaterialEditor.ShaderProperty(backFaceTextureSet, Styles.backFaceTextureSetText);
                if(material.GetFloat(kBackFaceTextureSet) == 1){
                    EditorGUILayout.HelpBox(Styles.doubleSidedHelpText, MessageType.Info);
                }
                EditorGUI.indentLevel--;
            }
            EditorGUI.indentLevel--;
