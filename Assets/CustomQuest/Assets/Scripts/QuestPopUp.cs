...
public class QuestPopUp : MonoBehaviour
{
    ...
    /// </summary>
    public ForExampleQuest forExampleQuest;
    ...
    {
        questUI.activeQuestPopUpQuests[player].Remove(forExampleQuest);
    }
    ...
    public void SetStartValues(QuestUI questUI)
    {
        ...
        if (questGiver != null)
        {
            title.text = forExampleQuest.questName;
            description.text = forExampleQuest.description;
            criterias.text = "";
            ...
            //    rewards.text += "\n";
            //}
            icon.sprite = forExampleQuest.questIcon;
        }
        else
        {
