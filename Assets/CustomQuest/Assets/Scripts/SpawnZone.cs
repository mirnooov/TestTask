...
//#endif
    ...
    private void Start()
    {
        ...
        if (Spawn == true)
        {
            if (Criteria.ForExampleQuest)
            {
                Criteria.ForExampleQuest.SpawnQuestObjects(Criteria.criteriaObject, initialSpawnAmount, this);
            }
            else
            {
                Debug.Log(Criteria.ForExampleQuest);
            }
        }
    }
