...
public class CQExamplePlayer : MonoBehaviour
{
    ...
    public void pickUpItem(Item item)
    {
        ...
        if (item.GetComponent<QuestObject>().criteria.ForExampleQuest.activeOptionalCriterias[cQPlayer].Contains(item.GetComponent<QuestObject>().criteria)) //Only picks up an item, if player is currently on the quest
        {
            items.Add(item);
        ...
        if (item.GetComponent<QuestObject>().criteria.ForExampleQuest.activeCriterias[cQPlayer].Contains(item.GetComponent<QuestObject>().criteria)) //Only picks up an item, if player is currently on the quest
        {
            items.Add(item);
            if (item.GetComponent<QuestObject>().criteria.type == criteriaType.Gather)
            {
