...
namespace CustomQuest
{
    ...
    {
        private static List<ForExampleQuest> editorQuests = new List<ForExampleQuest>();

        /// <summary>
        /// A list controlling the order of the quests in the editor
        /// </summary>
        public static List<ForExampleQuest> EditorQuests { get { return editorQuests; } set { editorQuests = value; SettingsHolder.prefabQuests = editorQuests; } }
        ...
        public static SettingsHolder SettingsHolder
        {
            get
            {
                ...
                {
#if UNITY_EDITOR
                    settingsHolder = (SettingsHolder)AssetDatabase.LoadAssetAtPath("Assets/CustomQuest/Assets/Prefabs/QuestSettings.asset", typeof(SettingsHolder));
#endif
        ...
        private static void CreateHolder()
        {
            ...
            AssetDatabase.CreateAsset(settingsHolder, "Assets/CustomQuest/Assets/Prefabs/QuestSettings.asset");
