...
public class CustomRewardPopUp : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        {
            bool invalid = false;
            string rewardName = questEditor.selectedForExampleQuest.name;
            ...
            if (invalid == false)
            {
                questEditor.ConvertToCustomReward(rewardToConvert, questEditor.selectedForExampleQuest); this.Close();
            }
            else
            {
